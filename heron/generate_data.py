...
from tools.data_helper import generate_frame, process_batch, sample_transition
...
model = keras.models.load_model('weights/23.04.2022_16.56.08_model_500')
...
while num_processed_batches < num_batches:
    ...
    for timestep in range(1, max_steps_per_episode):
        ...
        if show:
            ...
            generate_frame(state, winname=winname, scale=3, show_action=True, display=True)
